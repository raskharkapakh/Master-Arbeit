...
def full_parser(record):
    ...
    # in order to get to have similar dimensions as the eigenvectors, the eigenvalues (in R, not C) are stored in a diagonal matrix.
